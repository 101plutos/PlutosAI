...
Usage:
    python defi_cli_clean.py lend --wallet <addr> --asset ETH --amount 1.0 --protocol aave
    python defi_cli_clean.py yields --asset ETH --min-apr 5.0
    python defi_cli_clean.py positions --wallet <addr>
    python defi_cli_clean.py portfolio --wallet <addr>
    python defi_cli_clean.py withdraw --position <id> --amount 0.5
    python defi_cli_clean.py liquidity --wallet <addr> --token-a ETH --token-b USDC --amount-a 1.0 --amount-b 2000
    python defi_cli_clean.py stake --wallet <addr> --asset ETH --amount 5.0 --protocol lido
"""
